<?php
	...
	$squery  = "insert into expense_table (amount,category,date_col,day_col,month_col,mode,descp,user_id) values ($amount,$category,'$date_col','$day_col','$month_col',$mode,'$descp',$user_id)";
